...
public class BridgeConfiguration implements ConfigurationProperties, Serializable {
    ...
    public BridgeConfiguration name(String name) {
        this.name = name;
        return this;
    }
    ...
    public BridgeConfiguration desc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public BridgeConfiguration type(String type) {
        this.type = type;
        return this;
    }
    ...
    public BridgeConfiguration props(ConfigurationProperties props) {
        this.props = props;
        return this;
    }
